...
```{r glmnet model}
alphas = c(0.1, 0.25, 0.5, 1) # Set differens alphas
...
#factory function for product models
...
bs_probes = epimedtools::monitored_apply(mod=1, t(t(1:n_boot)), 1, function(i) { #epimedtools to see evolution of running 
