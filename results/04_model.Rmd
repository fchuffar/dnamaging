...
bs_func = function(i, idx_train=idx_train, model_params=model_params) { #epimedtools to see evolution of running 
...
if (USE_PARAPPLY) {
  ...
  ewas = parallel::parApply(cl, t(t(1:n_boot)), 1, bs_func, idx_train=idx_train, model_params=model_params)
} else {
