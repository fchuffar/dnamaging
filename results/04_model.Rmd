...
=======
cvrecaps = lapply(alphas, function(alpha, idx_train, y_key) { #list with cv recap (lambda,rmse,nbprobes) and lambda.min  
  print(alpha)
...
>>>>>>> a66b0f70f3b6b2abfdfaa262d83efeea36d63ea6
head(cvrecaps)
dim(cvrecaps)
```
...
```{amar plotting,eval = FALSE}
load("litterature_models.txt")
