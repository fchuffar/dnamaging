...
```{r boostrap}
bs_func = function(i, idx_train, model_params, mmodel_factory_glmnet, y_key=y_key) { #epimedtools to see evolution of running 
...
if (USE_PARAPPLY) {
  ...
  bs = parallel::parApply(cl_bs, t(t(1:n_boot)), 1, bs_func, idx_train=idx_train, model_params=model_params, mmodel_factory_glmnet=mmodel_factory_glmnet, y_key=y_key)
} else {
