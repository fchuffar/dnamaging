...
if (!exists("mcall_lm_mod")) {
  call_lm_mod = function(tmp_idx_train, tmp_idx_test, y_key, tmp_probes) {
...
stats = lapply(sort(unique(tmp_tab[tmp_tab>=n_boot/2])), function(occ) {
  print(occ)
  ...
  stats = lapply(1:length(folds), function(fold) {
    ...
    ret = mcall_lm_mod(tmp_idx_train, tmp_idx_test, y_key, tmp_probes)
    return(ret)
  })
