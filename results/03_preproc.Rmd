...
modelCR <- glmnet(XtrainS,Ytrain,standardize=TRUE,lambda=0.04,alpha = 0.8)

Xtrain = as.matrix(XtrainS)

predict(modelCR,XtrainS) #Erreur car vecteur trop grand et probleme méthode as.matrix 
...
modelHO <- DNAmAge(Xtrain,age=Ytrain,cell.count = FALSE, clocks = "Hannum")
