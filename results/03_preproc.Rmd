...
plotAMARCR = plotDNAmAge(PredCR,Ytest,paste0("AMAR Glmnet avec lambda = ",lambda, " et alpha = ",alpha))

plot.new()
plotAMARCR
text(0.2,1,paste0("RMSE = ",RMSECR))
...
modelHO = DNAmAge(XtestMC,age=Ytest,cell.count = FALSE, clocks = "Hannum")

RMSEHO = sqrt(mean((modelHO$age - modelHO$Hannum)^2))

plotAMARHO = plotDNAmAge(modelHO$Hannum, modelHO$age, "AMAR fonction DNAmAge with Hannum Method")

plot.new()
plotAMARHO
text(0.2,1,paste0("RMSE = ",RMSEHO))

modelHOr = DNAmAge(XtestMC,age=Ytest,cell.count = FALSE, clocks = "Horvath")

RMSEHOr = sqrt(mean((modelHOr$age - modelHOr$Horvath)^2))

plotAMARHOr = plotDNAmAge(modelHOr$Horvath, modelHOr$age, "AMAR fonction DNAmAge with Horvath Method")

plot.new()
plotAMARHOr
text(0.2,1,paste0("RMSE = ",RMSEHOr))

RMSE_compar = c(RMSECR,RMSEHO,RMSEHOr)
Names_RMSE = c("Selfmade Regression","Hannum method DNAmAge function","Horvath method DNAmAge function")
RMSE_compar = rbind(Names_RMSE,RMSE_compar)
