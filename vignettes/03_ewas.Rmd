...
if (nbewasprobes>0) {
  ...
  # head(fit$p.value)
  saveRDS(fit, paste0("fit_limma", nbewasprobes, "_nn", dist_nn, "_", gse, ".rds"))
...
if(dist_nn != 0){
  ...
  df_preproc = mreadRDS(paste0("df_preproc_",gse,".rds"))
...
```{r save_ewas}
saveRDS(df_ewas, paste0("df_r0_ewas", nbewasprobes, "_nn", dist_nn, "_", gse, ".rds"))
```
