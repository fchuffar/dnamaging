...
s$exp_grp[s$exp_grp$smoking_status%in%0,]$tobacco = "never"
s$exp_grp[s$exp_grp$smoking_status%in%1,]$tobacco = "former"
s$exp_grp[s$exp_grp$smoking_status%in%2,]$tobacco = "current"
