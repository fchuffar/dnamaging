...
# gse = "GSE42861" ; source(knitr::purl("01_build_study_generic.Rmd"))
# gse = "GSE42861" ; rmarkdown::render("01_build_study_generic.Rmd", output_file=paste0("01_build_study_", gse, ".html"))
# gse = "GSE42861"; nb_core=12; rmarkdown::render('00_fullpipeline1.Rmd', output_file=paste0("00_fullpipeline1_", gse, ".html"))
...
# gse = "GSE40279" ; rmarkdown::render('00_fullpipeline1.Rmd', output_file=paste0("00_fullpipeline1_", gse, ".html"))
...
s_filename = paste0("~/projects/datashare/study_", gse, ".rds")
...
df_filename = paste0("~/projects/datashare/df_", gse, ".rds")
print(paste0("Writing ", df_filename, "..."))
saveRDS(df, df_filename)
dim(df)

log_filename = paste0("~/projects/datashare/info_", gse, ".log")
