...
s_tmp$gse = gse
d = s_tmp$get_data(dest_dir="~/projects/datashare")
dim(d)
e = s_tmp$get_exp_grp()
dim(e)
head(e)

e$tobacco = e$"smoking_evernever:ch1"
e$tobacco = as.factor(e$tobacco)
e$age = as.numeric(e$"age_sampling:ch1")
e$gender = as.factor(e$"gender:ch1")

e = e[!is.na(e$tobacco),]

table(e$gender, e$tobacco, useNA="ifany")
...
if (s_tmp$platform_name=="GPL8490") {
  ...
  stop(paste0("platform problem ", gse, " ", s_tmp$platform_namE))
}
