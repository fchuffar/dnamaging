...
for (i in 1:5) {
    ...
    plot(pca$x[,i], pca$x[,j], 
    	...
    	pch=16)  
    points(pca_test[,i],pca_test[,j],col=adjustcolor(df_disease[df_disease$group == "test","col"],alpha.f=1),pch=".")
    points(pca_grimec[,i],pca_grimec[,j],col=adjustcolor(df_disease[df_disease$group == "grimec","col"],alpha.f=1),pch=17)
  }

# family 

palette(pals::polychrome())
df = df_family[df_family$group == "train",]
markers_start = grep("cg",colnames(df))[1]
idx_cpg = colnames(df)[markers_start:ncol(df)]

x <- df[,idx_cpg]
pca = prcomp(x, scale=FALSE)
test_acp = df_family[df_family$group == "test",colnames(x)]
pca_test = t(t(test_acp)-pca$center) %*% pca$rotation[,1:6]
grimec_acp = df_family[df_family$group == "grimec",colnames(x)]
pca_grimec = t(t(grimec_acp)-pca$center) %*% pca$rotation[,1:6]
v = pca$sdev * pca$sdev
p = v / sum(v) * 100
layout(matrix(1:6,3), respect=TRUE)
...
for (i in 1:5) {
    ...
    plot(pca$x[,i], pca$x[,j], 
    	...
    	col=adjustcolor(df$col,alpha.f=0.3),
    	pch=16)  
    points(pca_test[,i],pca_test[,j],col=adjustcolor(df_family[df_family$group == "test","col"],alpha.f=1),pch=".")
    points(pca_grimec[,i],pca_grimec[,j],col=adjustcolor(df_family[df_family$group == "grimec","col"],alpha.f=1),pch=17)
  }

# super_family

palette(pals::watlington())
df = df_sf[df_sf$group == "train",]
markers_start = grep("cg",colnames(df))[1]
idx_cpg = colnames(df)[markers_start:ncol(df)]

x <- df[,idx_cpg]
pca = prcomp(x, scale=FALSE)
test_acp = df_sf[df_sf$group == "test",colnames(x)]
pca_test = t(t(test_acp)-pca$center) %*% pca$rotation[,1:6]
grimec_acp = df_sf[df_sf$group == "grimec",colnames(x)]
pca_grimec = t(t(grimec_acp)-pca$center) %*% pca$rotation[,1:6]
v = pca$sdev * pca$sdev
p = v / sum(v) * 100
layout(matrix(1:6,3), respect=TRUE)
...
for (i in 1:5) {
    ...
    plot(pca$x[,i], pca$x[,j], 
    	...
    	col=adjustcolor(df$col,alpha.f=0.3),
    	pch=16)  
    points(pca_test[,i],pca_test[,j],col=adjustcolor(df_sf[df_sf$group == "test","col"],alpha.f=1),pch=".")
    points(pca_grimec[,i],pca_grimec[,j],col=adjustcolor(df_sf[df_sf$group == "grimec","col"],alpha.f=1),pch=17)
  }
...
points(umap_test[,1],umap_test[,2],col=adjustcolor(df_disease[df_disease$group == "test","col"],alpha.f=1),pch=".",cex=1)
points(umap_grimec[,1],umap_grimec[,2],col=adjustcolor(df_disease[df_disease$group == "grimec","col"],alpha.f=1),pch=17,cex=1)
...
x <- df[,idx_cpg]
umap = umap::umap(x)
test_umap = df_family[df_family$group == "test",colnames(x)]
umap_test = predict(umap,data=test_umap)
grimec_umap = df_family[df_family$group == "grimec",colnames(x)]
umap_grimec = predict(umap,data=grimec_umap)
layout(matrix(1,1), respect=TRUE)
plot(umap$layout,col=adjustcolor(df$col,alpha.f=0.3),pch=16,cex=1)
points(umap_test[,1],umap_test[,2],col=adjustcolor(df_family[df_family$group == "test","col"],alpha.f=1),pch=".",cex=1)
points(umap_grimec[,1],umap_grimec[,2],col=adjustcolor(df_family[df_family$group == "grimec","col"],alpha.f=1),pch=17,cex=1)
...
x <- df[,idx_cpg]
umap = umap::umap(x)
test_umap = df_sf[df_sf$group == "test",colnames(x)]
umap_test = predict(umap,data=test_umap)
grimec_umap = df_sf[df_sf$group == "grimec",colnames(x)]
umap_grimec = predict(umap,data=grimec_umap)
layout(matrix(1,1), respect=TRUE)

plot(umap$layout,col=adjustcolor(df$col,alpha.f=0.3),pch=16,cex=1)
points(umap_test[,1],umap_test[,2],col=adjustcolor(df_sf[df_sf$group == "test","col"],alpha.f=1),pch=".",cex=1)
points(umap_grimec[,1],umap_grimec[,2],col=adjustcolor(df_sf[df_sf$group == "grimec","col"],alpha.f=1),pch=17,cex=1)
...
col_conv$group = df_disease$group
...
plot(umap$layout,col=adjustcolor(col_conv[col_conv$group == "train","col_meth_class"],alpha.f=0.3),pch=16,cex=1)
points(umap_test[,1],umap_test[,2],col=adjustcolor(col_conv[col_conv$group == "test","col_meth_class"],alpha.f=1),pch=".",cex=1)
points(umap_grimec[,1],umap_grimec[,2],col=adjustcolor(col_conv[col_conv$group == "grimec","col_meth_class"],alpha.f=1),pch=17,cex=1)
...
plot(umap$layout,col=adjustcolor(col_conv[col_conv$group == "train","col_meth_family"],alpha.f=0.3),pch=16,cex=1)
points(umap_test[,1],umap_test[,2],col=adjustcolor(col_conv[col_conv$group == "test","col_meth_family"],alpha.f=1),pch=".",cex=1)
points(umap_grimec[,1],umap_grimec[,2],col=adjustcolor(col_conv[col_conv$group == "grimec","col_meth_family"],alpha.f=1),pch=17,cex=1)
...
plot(umap$layout,col=adjustcolor(col_conv[col_conv$group == "train","col_super_family"],alpha.f=0.3),pch=16,cex=1)
points(umap_test[,1],umap_test[,2],col=adjustcolor(col_conv[col_conv$group == "test","col_super_family"],alpha.f=1),pch=".",cex=1)
points(umap_grimec[,1],umap_grimec[,2],col=adjustcolor(col_conv[col_conv$group == "grimec","col_super_family"],alpha.f=1),pch=17,cex=1)
