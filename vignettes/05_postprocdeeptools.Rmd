...
# stop("EFN")
metaclusters = list(
  PRC2=c("cluster_1", "cluster_5"), 
  ENHA=c("cluster_2"), 
  PROM=c("cluster_3", "cluster_4"), 
  DEF1=c("cluster_6"), 
  DEF2=c("cluster_7")
)
...
mf = mget_mf_clust(bwfiles, bed_files, samplesLabel, prefix=prefix, othargs=paste0(" --refPointLabel 'loc' --legendLocation none --xAxisLabel ''  --colorMap RdBu --regionsLabel ", regionsLabel, " --heatmapWidth 2.8 --heatmapHeight 20"))
...
```{r figure deepTools, fig.width=6, fig.height=6}
...
# plot_deeptools()
png("deeptoolsfig.png", width=1500, height=900, res=150) 
# pdf("deeptoolsfig.pdf", width=8, height=6) 
plot_deeptools()
dev.off()
```
