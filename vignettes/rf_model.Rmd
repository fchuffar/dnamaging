...
gse = "trainGBMtest"
y_keys = c("meth_class","meth_family","super_family")
...
for (y_key in y_keys) {
	...
	saveRDS(df,paste0("df_r0_ewas", nbewasprobes, "_", gse,"_",y_key, ".rds"))
}
...
for (y_key in y_keys){
	df = readRDS(paste0("df_r0_ewas", nbewasprobes, "_", gse,"_",y_key, ".rds"))
