...
for (newas in c("200", "1000", "2000", "3000", "5000", "10000", "20000", "30000", "100000", "200000", "300000")) {
  print(paste0("****************newas: ", newas))
  source(knitr::purl("graphics_comparative_run.Rmd"))
}

for (newas in c("200000")) {
  print(paste0("****************newas: ", newas))
  source(knitr::purl("graphics_comparative_run.Rmd"))
}


for (newas in c("200", "1000", "2000", "3000", "5000", "10000", "20000", "30000", "200000", "300000")) {
  print(paste0("****************newas: ", newas))
...
recap_it_DMR = function(newas=2000, neighb=1000, run=0, pval=1e-30, study_filename, gse) { 
  ...
  rds_model_file = paste0("models_r",run,"_ewas",newas, "_nn", neighb, "_", gse, ".rds")
  if (!file.exists(rds_model_file)) {print(paste0("no file ", rds_model_file)) ; return()}
	for (i in 0:run) { 
    rds_model_file = paste0("models_r",i,"_ewas",newas, "_nn", neighb, "_", gse, ".rds")
...
for (pval in pvals) {
  ...
  ylim = c(0, max(global_stat$nb_probes_it_not_in_DMR + global_stat$nb_probes_it_in_DMR))
  ylim=c(0,1500)  
	plot(x = rownames(global_stat), y = global_stat$nb_probes_it_not_in_DMR, type = "b", col = "red",lty=1, ylim=ylim, main = paste0("comparison between DMR pval=", pval, " and iterative bs method for ewas ", newas))
...
plot(x, rmse_bs, axes=FALSE, xlab="", ylab="", 
   type="b", ylim=c(0,10), lty = 1, col="black", main=paste0("Comparison GLM/BS method for ewas=",newas))
...
legend("topleft",legend=c("RMSE for BS method","RMSE for GLM method", "nb probes for BS method", "nb probes for GLM method"),
  text.col=c("black","black","red","red"),col=c("black","black","red","red"), lty = c(1,2,1,2), cex=.7)
