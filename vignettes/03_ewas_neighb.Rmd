...
study_output_filename = paste0("./datashare/", gse, "/study_preproc_", prefix, ".rds")
df_output_filename = paste0("./datashare/", gse, "/df_preproc_", prefix, ".rds")
options(scipen=0)
```
...
idx_cpg_newas = rownames(bed[order(bed$pval),])[1:as.numeric(newas)]
...
pf_chr_colname = 1 
pf_pos_colname = 2
extend_region_dist = as.numeric(neighb)/2 - 1
...
df_output_filename = paste0("./datashare/", gse, "/df_preproc_", prefix, ".rds")
cmd = paste0("cd datashare/", gse, "; ln -s df_preproc_", prefix, ".rds df_preproc_r0_", prefix, ".rds; cd ../..")
print(cmd)
system(cmd)
```
...
saveRDS(info, paste0("info_ewas_neighb_", prefix, ".rds"))
print(info)
```
