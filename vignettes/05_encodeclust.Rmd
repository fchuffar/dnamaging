...
premimeth_probes = read.table("predimeth_probes_up_GSE147740_50.bed")[,4]
premimeth_probes_per_bed_files = lapply(names(probes_per_bed_files), function(bed_file) {  
  cnt = premimeth_probes[premimeth_probes %in% probes_per_bed_files[[bed_file]]]
  return(cnt)
})
names(premimeth_probes_per_bed_files) = names(probes_per_bed_files)
sapply(premimeth_probes_per_bed_files, length)

chi = data.frame(
  all = sapply(probes_per_bed_files, length),
  pdm = sapply(premimeth_probes_per_bed_files, length)
  exp = sapply(probes_per_bed_files, length) / probes_per_bed_files$bon * premimeth_probes_per_bed_files$bon 
)
chi$rat = chi$pdm / chi$all
chi
