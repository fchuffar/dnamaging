...
head(result[order(result$FDR),], 30)
...
# baz = sapply(1:nrow(res), function(i) {
# 		sum(!res[i,]$probes[[1]] %in% probes_per_bed_files$bonferroni01)
# })

# table_ewas = table_ewas[!is.na(table_ewas[,1]),]
...
layout(1, respect=TRUE)
predimethstatsfig()
pdf(paste0("fig_", gse, "_predimethstats.pdf"), width=6, height=6)
predimethstatsfig()
dev.off()
```
