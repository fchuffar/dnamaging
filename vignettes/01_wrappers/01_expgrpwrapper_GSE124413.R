# 1. age
s$exp_grp$"age at diagnosis (days):ch1"
s$exp_grp$age = round(as.numeric(as.character(s$exp_grp$"age at diagnosis (days):ch1"))/365.25,2)
sort(s$exp_grp$age)
...
# 5. disease
s$exp_grp$disease = as.factor("AML")
