...
pf_chr_colname = "CHR_hg38"
pf_pos_colname = "Start_hg38"
...
if (FILTER_EWAS_FOR_DMR_CANDIDATE) {
  dmr_candidates = mbuild_dmr_candidates(pf=pf, pf_chr_colname=pf_chr_colname, pf_pos_colname=pf_pos_colname)
...
bed = pf[rownames(ewas),c(pf_chr_colname, pf_pos_colname)] # Warning, here pf is global, it must be arg and indexed!!
head(bed)
bed[,3] = bed[,2]+1
bed$probes = rownames(ewas)
bed$pval = 10^-ewas[,"lpv"]
bed$strand = "+"
