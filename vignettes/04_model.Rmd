...
df = mreadRDS(paste0("./datashare/", gse_short, "/df_preproc_r", run, "_", gse, ".rds"))
...
saveRDS(list(best_model_cvaglmnet, best_model_bs), paste0("models_r", run,"_ewas", newas, "_nn", neight, "_", gse, ".rds"))
```
...
saveRDS(info, paste0("info_model_r", run,"_ewas", newas, "_nn", neight, "_", gse, ".rds"))
```
