...
if (exists("custom_idx_train") & exists("custom_idx_test")) { # for same train / test set for GSE147740 and CustGSE147740rr
  idx_train = custom_idx_train
  idx_test  = custom_idx_test 
} else if (!exists("MODESA")) {
  set.seed(seed)
