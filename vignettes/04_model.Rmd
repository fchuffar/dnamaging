...
for (covariate in covariates) {
  ...
  names(info) = c("ElasticNet", "Bootstrap", "Hannum", "Horvath") 
  info$ElasticNet$alpha  = best_model_cvaglmnet_params$alpha
  info$ElasticNet$lambda = best_model_cvaglmnet_params$lambda 
}
...
dim(df)
saveRDS(df,paste0("df_r", run+1, "_ewas", nbewasprobes, "_", gse, ".rds"))
