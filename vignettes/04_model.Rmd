...
if(typeofmodel == "bs"){
  ...
  dim(df)
  saveRDS(df,paste0("df_r", run+1, "_bs", "_ewas", nbewasprobes, "_", gse, ".rds"))
}
...
if(typeofmodel == "glm"){
  ...
  dim(df)
  saveRDS(df,paste0("df_r", run+1, "_glm", "_ewas", nbewasprobes, "_", gse, ".rds"))
}
...
saveRDS(info, paste0("info_model_r", run,"_", typeofmodel, "_ewas", nbewasprobes, "_", gse, ".rds"))
```
